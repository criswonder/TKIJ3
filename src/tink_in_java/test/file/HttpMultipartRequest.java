...
public class HttpMultipartRequest {
    ...
    public static void main(String[] args) {
        ...
        fileParams.add(new String[] {"files","button_push.9.png","image/png", "c://button_push.9.png"});
        HttpMultipartRequest req = 
                new HttpMultipartRequest("http://clw.17car.com.cn/car/reportcase.action?userid=3&carid=2&jingdu=1001&weidu=46", stringParams, fileParams);
        try {
        ...
        try {
            ...
            if (strParams != null) {
                for (String[] parsm : strParams) {
                    ...
                    resSB.append("Content-Disposition: form-data; name=\"").append(key).append("\"/r/n").append("/r/n")
            ...
            if (fileParams != null) {
                for (int i = 0, num = fileParams.size(); i < num; i++) {
                    ...
                    resSB.append("Content-Disposition: form-data; name=\"").append(fileField).append("\"; filename=\"")
                            .append(fileName).append("\"/r/n").append("Content-Type: ").append(fileType)
                            .append("/r/n/r/n");
