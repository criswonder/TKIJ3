...
public class IOStreamDemo {
	...
	public static void main(String[] args) throws IOException {
		...
		int c;
		while ((c = in2.read()) != -1)//add by andy, c is the character code
			System.out.print((char) c);
		// 3. Formatted memory input
		try {
			//DataInputStream, which is a byteoriented
			//I/O class (rather than char oriented).
